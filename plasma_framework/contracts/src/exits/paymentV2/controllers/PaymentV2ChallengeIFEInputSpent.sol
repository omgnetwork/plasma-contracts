...
library PaymentV2ChallengeIFEInputSpent {
    ...
    struct ChallengeIFEData {
        ...
        PaymentV2InFlightExitRouterArgs.ChallengeInputSpentArgs args;
        PaymentV2ExitDataModel.InFlightExit ife;
    }
    ...
    function run(
        ...
        PaymentV2InFlightExitRouterArgs.ChallengeInputSpentArgs memory args
    )
        public
    {
