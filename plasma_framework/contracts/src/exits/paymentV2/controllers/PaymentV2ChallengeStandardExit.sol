...
import "../routers/PaymentV2StandardExitRouterArgs.sol";
...
library PaymentV2ChallengeStandardExit {
    ...
    struct ChallengeStandardExitData {
        ...
        PaymentV2StandardExitRouterArgs.ChallengeStandardExitArgs args;
        PaymentV2ExitDataModel.StandardExit exitData;
    ...
    function run(
        ...
        PaymentV2ExitDataModel.StandardExitMap storage exitMap,
        PaymentV2StandardExitRouterArgs.ChallengeStandardExitArgs memory args
    )
        public
    {
    ...
    function verifySpendingCondition(ChallengeStandardExitData memory data) private view {
        PaymentV2StandardExitRouterArgs.ChallengeStandardExitArgs memory args = data.args;
