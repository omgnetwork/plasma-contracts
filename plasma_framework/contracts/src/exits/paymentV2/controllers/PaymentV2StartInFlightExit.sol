...
library PaymentV2StartInFlightExit {
    ...
    function run(
        ...
        PaymentV2InFlightExitRouterArgs.StartExitArgs memory args
    )
        public
    {
    ...
    function verifyExitNotStarted(
        ...
        view
    {
        PaymentV2ExitDataModel.InFlightExit storage exit = inFlightExitMap.exits[exitId];
    ...
    function startExit(
        ...
        private
    {
        PaymentV2ExitDataModel.InFlightExit storage ife = inFlightExitMap.exits[startExitData.exitId];
    ...
    function setInFlightExitInputs(
        PaymentV2ExitDataModel.InFlightExit storage ife,
        StartExitData memory exitData
    )
        private
    {
