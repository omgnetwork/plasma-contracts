...
library PaymentV2StartStandardExit {
    ...
    struct StartStandardExitData {
        ...
        PaymentV2StandardExitRouterArgs.StartStandardExitArgs args;
        ...
        view
    {
        ...
        PaymentV2ExitDataModel.StandardExit memory exit = exitMap.exits[data.exitId];
    ...
    function saveStandardExitData(
        ...
        private
    {
        exitMap.exits[data.exitId] = PaymentV2ExitDataModel.StandardExit({
            exitable: true,
