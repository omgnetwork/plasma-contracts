const PaymentTransactionStateTransitionVerifier = artifacts.require('PaymentV2TransactionStateTransitionVerifier');
...
contract('PaymentV2TransactionStateTransitionVerifier', ([alice, bob]) => {
