...
contract('PaymentV2ProcessInFlightExit', ([_, ifeBondOwner, inputOwner1, inputOwner2, inputOwner3, outputOwner1, outputOwner2, outputOwner3]) => {
    ...
    before('deploy and link with controller lib', async () => {
        ...
        await PaymentInFlightExitRouter.link('PaymentV2DeleteInFlightExit', deleteInFlightEixt.address);
